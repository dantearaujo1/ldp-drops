      ...
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="w-80 p-4 text-center transition-transform hover:scale-105">
            <img src="qrcode.png" alt="QR Code" className="w-48 h-48 object-cover mx-auto" />
          ...
          <div className="w-80 p-4 text-center transition-transform hover:scale-105">
            <img src="drop.png" alt="Aperte o botão" className="w-48 h-48 object-cover mx-auto" />
          ...
          <div className="w-80 p-4 text-center transition-transform hover:scale-105">
            <img src="water.png" alt="Entrega de água" className="w-48 h-48 object-cover mx-auto" />
